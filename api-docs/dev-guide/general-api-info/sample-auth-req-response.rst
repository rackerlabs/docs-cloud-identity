...
and request body for the POST tokens API operation. When you authenticate, use your own 
credentials for user name and API key rather than the sample values shown in the examples. 
For attribute descriptions, see the authentication request attribute descriptions in the 
