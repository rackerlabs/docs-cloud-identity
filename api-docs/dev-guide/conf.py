...
html_title = 'Rackspace Cloud Identity version 1.0 API Developer Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Identity'
...
htmlhelp_basename = 'RackspaceCloudApiIdentityDeveloperDoc'
...
latex_documents = [
  ('index', 'RackspaceCloudApiIdentityDeveloperDoc.tex', 'Rackspace Cloud Identity API Developer Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    ('index', 'RackspaceCloudApiIdentityDeveloperDoc', 'Rackspace Cloud Identity API Developer Guide',
     ['Rackspace'], 1)
]
...
texinfo_documents = [
  ('index', 'RackspaceCloudApiIdentityDeveloperDoc', 'Rackspace Cloud Identity API Developer Guide',
   'Rackspace', 'RackspaceCloudApiIdentityDeveloperDoc', 'Learn about using the REST API for the Rackspace Cloud Identity /service.',
   'Miscellaneous'),
]
