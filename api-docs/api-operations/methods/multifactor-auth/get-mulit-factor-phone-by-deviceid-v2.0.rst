...
Use this operation to retrieve the multi-factor mobile phone for a specified user account by 
device ID.  This request is useful if you want to locate the phone number for a device 
registered to a user account for multi-factor authentication. 
