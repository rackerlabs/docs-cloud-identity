...
Identity service <https://support.rackspace.com/how-to/multi-factor-authentication-from-the-myrackspace-portal/>`__
to register the OTP device with a mobile passcode
