...
.. _post-creates-an-otp-device-v2.0-users-userid-rax-auth-multi-factor-otp-devices:
...
**Example Add an OTP device: XML request header**
...
**Example Add an OTP device: JSON request header**
...
**Example Add an OTP device: XML response header**
...
**Example Add a moble phone: JSON response header**
