...
.. _post-authenticate-as-tenant-with-token-v2.0-tokens:
...
+-------------------------+-------------------------+--------------------------+
|403                      |User disabled            |This error can be         |
|                         |                         |returned if the request   |
|                         |                         |is valid, but you do not  |
|                         |                         |have permission to access |
|                         |                         |the requested resource.   |
|                         |                         |If your account requires  |
|                         |                         |multi-factor              |
